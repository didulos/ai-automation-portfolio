...
이 저장소는 AI 업무자동화와 바이브코딩 학습 과정에서 만든 실습 기록입니다. 
완성된 상용 서비스라기보다, 문제를 정의하고 자동화 구조를 실험하며 학습한 내용을 정리한 포트폴리오입니다.

## 대표 실습

1. n8n 기반 자동화 워크플로우 실습
- 트리거, 조건 분기, API 연동 구조 이해
- 자동화 실패 지점 확인 및 수정 경험

2. Claude / ChatGPT를 활용한 코드 오류 해결 실습
- 오류 메시지 분석
- 원인 후보 정리
- 수정 코드 적용 후 재검증

3. Python 기반 간단한 자동화 실습
- 파일 처리
- CSV 데이터 정리
- 반복 작업 자동화 구조 학습
